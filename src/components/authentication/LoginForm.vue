...
<template>
  <form>
    <div class="mb-4">
      ...
      <!-- input V-model email -->
      <input v-model="formLogin.email" placeholder="Type your email" id="email" type="text" name="email"
    ...
    <div class="mb-4">
      ...
      <input v-model="formLogin.password" placeholder="Type your password" id="password" type="password" name="password"
        class="block w-full py-3 mt-2 border border-gray-300 rounded-full shadow-sm px-7 focus:border-indigo-300 focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-opacity-50 disabled:bg-gray-100" />
    </div>
    <div class="mt-6">
      <button type="button"
